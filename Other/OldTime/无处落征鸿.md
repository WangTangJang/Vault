...
![image-20230317162819528](image-20230317162819528.png)
...
![image-20230317162825442](image-20230317162825442.png)

### Tomcat

使用idea启动tomcat无法打开主页

![image-20230317162940846](image-20230317162940846.png)

解决方法：在idea的tomcat上也部署一下它(tomcat)那些自带的webapp

 ![image-20230317162840483](image-20230317162840483.png)
...
![image-20230507224623447](image-20230507224623447.png)

按着网上找到资料在<http://archive.apache.org/dist/jakarta/taglibs/standard/binaries/下载:>

![image-20230507224746168](image-20230507224746168.png)

然后将其中的两个:

![image-20230507225013920](image-20230507225013920.png)

放入到项目的lib内

![image-20230507225116932](image-20230507225116932.png)

引用库：

![image-20230507225200364](image-20230507225200364.png)

![image-20230507225230532](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230507225230532.png)

然后再设置中：

![image-20230507231343340](image-20230507231343340.png)

添加tld：

![image-20230507231431440](image-20230507231431440.png)

即可。

但是第一次错下了最久的版本:

![image-20230507224837831](image-20230507224837831.png)
...
记得更新此处
![image-20230606181837111](image-20230606181837111.png)
...
![image-20230604150206472](image-20230604150206472.png)

### 5.令控制台编码格式UTF-8

![image-20230609190704433](image-20230609190704433.png)
...
![image-20230506230313453](image-20230506230313453.png)

![image-20230506230208344](image-20230506230208344.png)!
