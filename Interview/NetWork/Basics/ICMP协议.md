ICMP（Internet Control Message Protocol）是一种在[[什么是 OSI 模型？#3.网络层（Network Layer）：|网络层]]工作的协议，主要用于在IP网络上传递**控制消息**和**错误报告**。ICMP协议的设计旨在提供有关网络通信的信息，以及用于网络故障排除和错误处理的机制。
以下是关于ICMP的一些重要信息：
